...
#####################################################################################
#     DBMS Name				  :  TERADATA											#
#     Database Name			  :  logistics_user										#
#     Application			  :  GBI POLARIS										#
#     Program Name			  :  SP_LOAD_EM_CARRIER_DQ_RAW_FILE.sql					#
#     Purpose				  :														#
#																					#
#     Description			  :														#
#																					#
#																					#
#																					#
#     IN Parameters			  :  <Input parameters for procedure execution>			#
#     Program Executing The Procedure:	<Name of program that invokes the procedure>#
#     Procedures Invoked inside the Procedure : log_process_run_message				#
#####################################################################################
#			     Creation/Modification Details										#
#####################################################################################
#																					#
#    WHEN	      Who		     What				Reference						#
#  02-Nov-2014,	    GBI POLARIS Team,	    Initial Version,			CR #		#
#  04-Dec-2014		GBI POLARIS Team,	Enhancement,			CR #21163386		#
#  14-Dec-2014		GBI POLARIS Team,	Enhancement,			CR #21353452		#
#										rdar://problem/18975559						#
#										rdar://problem/18630546						#
#										rdar://problem/18630719						#
#										rdar://problem/18633100						#
#										rdar://problem/18646115						#
#										rdar://problem/18660181						#
#										rdar://problem/18665306						#
#										rdar://problem/19175491						#
#										rdar://problem/18663845						#
#  22-Jan-2015		GBI POLARIS Team,	Enhancement,			CR #21719292		#
#										rdar://problem/19411760						#
#										rdar://problem/19483887						#
#										rdar://problem/19398257						#
#										rdar://problem/19514291						#
#  06-Feb-2015		GBI POLARIS Team,	Enhancement,			CR #21880593		#
#										rdar://problem/19333452						#
#  02-Mar-2015	GBI POLARIS Team,	Re Architecture				CR #22493958		#
#  22-Jun-2015	GBI POLARIS Team,	Enhancement					CR #23262365		#
#										rdar://problem/18630812						#
#										rdar://problem/19696798						#
#										rdar://problem/18666265						#
#										rdar://problem/18666379						#
#										rdar://problem/18666143						#
#										rdar://problem/18386556						#
#  20-Aug-2015	GBI POLARIS Team,	Enhancement					CR #				#
#										rdar://problem/22276474						#
#####################################################################################
*/
/* HEADER ENDS*/
...
BEGIN
		...
		/*DECALRE VARIABLE FOR ERROR HANDLING ENDS*/
		...
		/*DECALRE VARIABLE FOR HISTORY DELETION*/
		...
		/*DECALRE VARIABLE FOR HISTORY DELETION ENDS*/
		...
		/* Rolling week -1 will give last week dates. MIN , MAX gives the loading range */
...
/*WORK TABLE HEADER STARTS*/
/*
#####################################################################################
#		 Work Table  Header															#
#####################################################################################
#      Work Table  : wrk_em_dq_shipments											#
#      Purpose	  : Incremental week shipments with handler number					#
#																					#
#																					#
#      Number of records inserted : 600k ~ 700k										#
#      Type Of Refresh	 : Complete													#
#####################################################################################
*/
/*WORK TABLE HEADER ENDS*/
...
#		 Work Table  Header																#
#########################################################################################
#      Work Table  : wrk_em_dq_doc_id_info												#
#      Purpose	  : DN,PO,Order_Id info for incremental shipments at shipment level		#
#																						#
#																						#
#      Number of records inserted : 600k ~ 700k											#
#      Type Of Refresh	 : Complete														#
...
#		 Work Table  Header																#
#########################################################################################
#      Work Table  : wrk_em_carrier_dq_event_dtls										#
#      Purpose	  : this table holds attributes from shipment event with marking 1st,last events #
#																						#
#																						#
#      Number of records inserted : 6M ~ 10M											#
#      Type Of Refresh	 : Complete														#
#########################################################################################
*/
/*WORK TABLE HEADER ENDS*/
		...
		(
			...
			,reason_cd			-- new column added for dq enhancement phase 2<rdar://problem/20518202/21911522>Delay Code Completion & Latency
	    ,reason_desc		    -- new column added for dq enhancement phase 2<rdar://problem/20518202/21911522>Delay Code Completion & Latency
		)
		SELECT 
			...
			,ese.reason_cd			   -- new column added for dq enhancement phase 2<rdar://problem/20518202/21911522>Delay Code Completion & Latency
	    ,ese.reason_desc		       -- new column added for dq enhancement phase 2<rdar://problem/20518202/21911522>Delay Code Completion & Latency
		FROM 
			logistics_app.wrk_em_dq_shipments wrk1 
...
/* duplicating AP message for creating event First Attempt */		
		...
		SELECT 
			...
			,event_msg_nr
			,event_cd
			,'First Attempt'					-- DQ Enhancement Phase 2<rdar://problem/21216049>First Attempt Latency Measurement
			,event_phase_cd
			,region_cd
			,sender_nr
			,sender_name
		...
		/* START : Exclude carrier for appointment requested AS PART OF rdar://problem/19696798 */ 
		...
		/*END : Exclude carrier for appointment requested AS PART OF rdar://problem/19696798 */ 
		
-------------------------------------------------------------------------------------------------------------------
		COLLECT STATS ON  logistics_app.wrk_em_carrier_dq_event_dtls ;
-------------------------------------------------------------------------------------------------------------------

/* New uplift logic - rdar://problem/18630812 */ 
...
#		 Work Table  Header															#
#####################################################################################
#      Work Table  : wrk_em_dq_fiscal_dt_qualifier									#
#      Purpose	  : this table have necessary attributes from previous table for completion date calculation		#
#																					#
#																					#
#      Number of records inserted : 2M~3M											#
#      Type Of Refresh	 : Complete													#
#####################################################################################
*/
/*WORK TABLE HEADER ENDS*/
...
#		 Work Table  Header																#
#########################################################################################
#      Work Table  : wrk_em_dq_fiscal_dates												#
#      Purpose	  : this table have the calculated fiscal/completion date at shipment , scac(,sender) level			#
#																						#
#																						#
#      Number of records inserted : 600K~900k											#
#      Type Of Refresh	 : Complete														#
#########################################################################################
*/
/*WORK TABLE HEADER ENDS*/
		...
		SELECT 
			...
			COALESCE(
				...
				CASE 
					...
					) AS fiscal_dt	-- DQ Enhancement Phase 2 <rdar://problem/19411760>Expected POD Date/Time Logic
		FROM 
			logistics_app.wrk_em_dq_fiscal_dt_qualifier  a
			LEFT OUTER JOIN logistics_app.wrk_em_dq_fiscal_dt_qualifier  b -- D1 event
			...
			LEFT OUTER JOIN logistics_app.wrk_em_dq_fiscal_dt_qualifier  b2 -- J1 event
			...
			LEFT OUTER JOIN logistics_app.wrk_em_dq_fiscal_dt_qualifier  c -- AG event
			...
			LEFT OUTER JOIN logistics_app.wrk_em_dq_fiscal_dt_qualifier  d -- AB , AD event
			...
			LEFT OUTER JOIN logistics_app.wrk_em_dq_fiscal_dt_qualifier  e -- CL event
...
#		 Work Table  Header															#
#####################################################################################
#      Work Table  : wrk_em_dq_event_latency_dtls									#
#      Purpose	  : this table holds the 1st and last events with latency figures and associated completion date	#
#																					#
#																					#
#      Number of records inserted : 3M~5M											#
#      Type Of Refresh	 : Complete													#
#####################################################################################
*/
/*WORK TABLE HEADER ENDS*/
		...
		(
			...
			,all_tracking_nr
			,uplift_reqd_ind
			,reason_cd			    -- new column added for dq enhancement phase 2
	    ,reason_desc			-- new column added for dq enhancement phase 2
	    ,scac_first_occurrence_ind			-- New Columns for DQ Enhancement	phase 2<rdar://problem/20056991>EDD Accuracy Measurement #3 [AG to D1]
	    ,scac_last_occurrence_ind		-- New Columns for DQ Enhancement   phase 2<rdar://problem/20056991>EDD Accuracy Measurement #3 [AG to D1]
		)
		SELECT 
			wrk3.event_handler_nr 
			,wrk3.shipment_id
			...
			,wrk3.reason_cd	 
	    ,wrk3.reason_desc 
	    ,wrk3.scac_first_occurrence_ind			-- New Columns for DQ Enhancement
	    ,wrk3.scac_last_occurrence_ind		-- New Columns for DQ Enhancement
		FROM 
			logistics_app.wrk_em_carrier_dq_event_dtls wrk3 
		...
		(
			...
			,reason_cd			
	    ,reason_desc       
	    ,scac_first_occurrence_ind			-- New Columns for DQ Enhancement Phase 2
	    ,scac_last_occurrence_ind		-- New Columns for DQ Enhancement Phase 2
		)
		SELECT 
			wrk3.event_handler_nr 
			,wrk3.shipment_id
			...
			,wrk3.reason_cd			
	    ,wrk3.reason_desc		  
	    ,wrk3.scac_first_occurrence_ind			-- New Columns for DQ Enhancement Phase 2
	    ,wrk3.scac_last_occurrence_ind		-- New Columns for DQ Enhancement Phase 2
		FROM 
			logistics_app.wrk_em_carrier_dq_event_dtls wrk3 
			LEFT OUTER JOIN logistics_app.wrk_em_dq_fiscal_dates  wrk5
...
#		 Work Table  Header															#
#####################################################################################
#      Work Table  : wrk_em_dq_event_uplift_dtls									#
#      Purpose	  : This table adds uplift and shipping point information			#
#																					#
#																					#
#      Number of records inserted : 3M~5M											#
#      Type Of Refresh	 : Complete													#
...
/*WORK TABLE HEADER ENDS*/
		...
		(
			...
			all_tracking_nr ,
			ship_from_city_name,
			chargeable_wt_kg_msr,	      -- new column added for dq enhancement phase 2<rdar://problem/20043649>Chargeable Weight Completion
			chargeable_wt_lb_msr,	      -- new column added for dq enhancement phase 2<rdar://problem/20043649>Chargeable Weight Completion
			reason_cd,		      -- new column added for dq enhancement phase 2
	    reason_desc,		  -- new column added for dq enhancement phase 2
	    scac_first_occurrence_ind,
	    scac_last_occurrence_ind,
		...
		SELECT 
			...
			CASE	
		WHEN ehs.region_cd ='PAC' AND ehs.process_type_cd IN  ('ZIPS') THEN 'N' /*Added as part of Dec A Release <rdar://problem/18646115> APAC - Week 1 - Uplift Logic - Exclude Print Service Shipments from Uplift (Dec Rlease)*/
	    ...
	    CASE WHEN ehs.chargeable_wt_uom_cd='KG' THEN (2.20462*Chargeable_Wt_Msr) ELSE chargeable_wt_msr END AS chargeable_wt_lb_msr, 
			...
			CASE 
				WHEN wrk6.event_phase_cd='Estimated' AND wrk6.event_name='Delivered' AND wrk6.scac_first_occurrence_ind=1 AND wrk6.scac_last_occurrence_ind=1 THEN 'Y' /* if same event is both 1st and last then this will get reported in summary */
				WHEN wrk6.event_phase_cd='Estimated' AND wrk6.event_name='Delivered' AND wrk6.scac_first_occurrence_ind=1 AND wrk6.scac_last_occurrence_ind=0 THEN 'N' /* 1st estimated delivered is not reported in summary */
				ELSE 'Y' END AS smmry_rptg_cd, -- Added for keeping 1st and last Estimated Delivered 
		...
		WHERE 
			...
			--AND 
			--a.region_cd IN ('PAC','EURO') /* Commented out as per AMR also need this*/
		; 
		...
		WHERE 
			...
			a.region_cd IN ( 'PAC','AMR')	/* Added AMR */
		; 
...
/* UPDATING MAIN TABLE FOR WEEKLY REPORTED RECORDS */
...
/* UPDATING MAIN TABLE FOR MONTHLY REPORTED RECORDS */
...
/* UPDATING MAIN TABLE FOR QUARTERLY REPORTED RECORDS */
...
/*MAIN TABLE HEADER STARTS*/
/*
#####################################################################################
#		 Main Table  Header															#
#####################################################################################
#      Main Table  : EM_CARRIER_DQ_RAW_FILE											#
#      Purpose	 : Base table for all the reports									#
#																					#
#																					#
...
/*MAIN TABLE HEADER ENDS*/
		...
		WHERE 
			...
			AND ecd.smmry_rptg_cd=wrk7.smmry_rptg_cd		-- Added for keeping 1st and last Estimated Delivered 
		; 
		...
		(
			...
			,chargeable_wt_kg_msr	       -- new column added for dq enhancement phase 2
	    	,chargeable_wt_lb_msr	   -- new column added for dq enhancement phase 2
	    	,reason_cd			   -- new column added for dq enhancement phase 2
	    	,reason_desc		   -- new column added for dq enhancement phase 2
	    	,scac_first_occurrence_ind	   -- new column added for dq enhancement phase 2
	    	,scac_last_occurrence_ind		-- new column added for dq enhancement phase 2
	    	,smmry_rptg_cd					-- new column added for dq enhancement phase 2
	    	,scheduled_delivery_gmt_ts	    -- new column added for dq enhancement phase 2
	    	,carrier_leg_cd
	    	,event_phase_name
	    	,service_cd
			,ldw_batch_sk					-- new column added for dq enhancement phase 2
			,ldw_change_ts					-- new column added for dq enhancement phase 2
	    ...
	    ,wrk7.reason_cd  
	    ,wrk7.reason_desc 
	    ,wrk7.scac_first_occurrence_ind	   -- new column added for dq enhancement phase 2
	    ,wrk7.scac_last_occurrence_ind		-- new column added for dq enhancement phase 2
	    ,wrk7.smmry_rptg_cd					-- new column added for dq enhancement phase 2
	    ,wrk7.scheduled_delivery_gmt_ts	-- new column added for dq enhancement phase 2
	    ,wrk7.carrier_leg_cd
	    ,wrk7.service_cd
...
/*UPDATING BASE TABLE FOR LATENCY AND COMPLETION INDICATORS */

		UPDATE logistics_app.em_carrier_dq_raw_file
		SET compltn_wkly_sent_ind='N' 
		WHERE fiscal_dt BETWEEN ld_start_dt AND ld_end_dt 
		AND smmry_rptg_cd='Y' AND event_cd NOT IN ('AP','SD');			-- Added to restrict first estimated event to appear in summary reports, AP and SD do not go to completion

		UPDATE logistics_app.em_carrier_dq_raw_file
		SET latency_wkly_sent_ind='N' 
		WHERE B2B_Dt BETWEEN ld_start_dt AND ld_end_dt
		AND smmry_rptg_cd='Y';			-- Added to restrict first estimated event to appear in summary reports
		
		/* START : Added as part of rdar://problem/19696798 */
		
		UPDATE logistics_app.em_carrier_dq_raw_file
		SET compltn_wkly_sent_ind='Y'											/* rdar://problem/22276474 : Add TW where CN */
		...
		/* END : Added as part of rdar://problem/19696798 */
		
		/* <rdar://problem/21892935>Completion Inclusion/Exclusion Logic */
...
#		 Work Table  Header															#
#####################################################################################
#      Work Table  : wrk_em_dq_sent_items											#
#      Purpose	   :																#
#																					#
#																					#
#      Number of records inserted :													#
...
#		 Main Table  Header													#
#############################################################################
#      Main Table  : EM_CARRIER_DQ_WK_ACCURACY								#
#      Purpose	   : This table holds data for weekly accuracy measurement	#
#																			#
#																			#
#      Number of records inserted :											#
#      Type Of Refresh	 : Complete											#
...
/* Updating the difference columns*/
    ...
    SET
		    ...
		    ,est_pod_diff_hr_val      = CASE WHEN lst_est_del_b2b_dt > '2000-01-01' AND lst_est_del_b2b_dt < '2030-01-01' 
									...
									ELSE NULL END						/* <rdar://problem/20044191>EDD Latency Measurement #2 - [AG to D1]  */
		    ...
		    ,est_pod_diff_dy_val      = CASE WHEN lst_est_del_gmt_dt > '2000-01-01' AND lst_est_del_gmt_dt < '2030-01-01' 
									...
									ELSE NULL END						/* <rdar://problem/20056991>EDD Accuracy Measurement #3 [AG to D1] */
...
/* Monthly Processing  */
		IF ld_end_dt = ld_month_end_dt THEN 
			...
			AND smmry_rptg_cd='Y' AND event_cd NOT IN ('AP','SD');			-- Added to restrict first estimated event to appear in summary reports
...
#		 Work Table  Header															#
#####################################################################################
#      Work Table  : wrk_em_dq_sent_items_mth										#
#      Purpose	   :																#
#																					#
#																					#
#      Number of records inserted :													#
...
#		 Main Table  Header													#
#############################################################################
#      Main Table  : EM_CARRIER_DQ_MTH_ACCURACY								#
#      Purpose	   : This table holds data for weekly accuracy measurement	#
#																			#
#																			#
#      Number of records inserted :											#
...
#		 Work Table  Header															#
#####################################################################################
#      Work Table  : wrk_em_dq_sent_items_qtr										#
#      Purpose	   :																#
#																					#
#																					#
#      Number of records inserted :													#
...
#		 Main Table  Header													#
#############################################################################
#      Main Table  : EM_CARRIER_DQ_QTR_ACCURACY								#
#      Purpose	   : This table holds data for weekly accuracy measurement	#
#																			#
#																			#
#      Number of records inserted :											#
...
/**************************************End of Procedure for populating the detail table********************************/
